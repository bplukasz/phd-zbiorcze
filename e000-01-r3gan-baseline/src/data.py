"""Data loading for e000-01-r3gan-baseline — reuses logic from e001-01."""
...
def get_dataloader(data_dir: str, img_resolution: int, batch_size: int,
    ...
    if dataset_name == "celeba":
        ...
        steps = [transforms.Resize(img_resolution), transforms.ToTensor()]
        if img_channels == 3:
    ...
    print(f"Dataset: {dataset_name}, size: {len(dataset)}, img_resolution: {img_resolution}, ch: {img_channels}")
    return loader
