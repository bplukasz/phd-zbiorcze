"""
Eksperyment: e002-01-gan-cluster-metrics-resnet gan with cluster-fid and e11 metrics
...
def train(profile: str = "preview", overrides: Optional[Dict[str, Any]] = None) -> Tuple[nn.Module, List[float]]:
    ...
    print(f"=" * 60)
    print(f"Eksperyment: e002-01-gan-cluster-metrics-resnet gan with cluster-fid and e11 metrics")
